    ...
    <el-row>
      <el-col :span="12">
        ...
        <ul class="list-unstyled">
          ...
          <!--<li class="link-type"><a href="https://gitee.com/moxi159753/mogu_blog_v2">小橙@博客源码</a></li>-->
          <!--<li class="link-type"><a href="http://moxi159753.gitee.io/mogu_blog_doc">小橙@博客文档</a></li>-->
